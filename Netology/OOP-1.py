...
student_1 = Student('Катя', 'Уинслетова', 'ж')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ["Введение в программирование"]

student_2 = Student('Том', 'Хардин', 'м')
student_2.courses_in_progress += ['Python']
student_2.finished_courses += ["Введение в программирование"]

lecturer_1 = Lecturer('Николай', 'Кейджев')
lecturer_1.courses_attached += ['Python']

lecturer_2 = Lecturer('Али', 'Пачинов')
lecturer_2.courses_attached += ['Python']

reviewer_1 = Reviewer('Ангелина', 'Джолина')
reviewer_1.courses_attached += ['Python']

reviewer_2 = Reviewer('Леонид', 'Дикаприонян')
